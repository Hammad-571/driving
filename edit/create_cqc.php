<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $q = " INSERT INTO CQC (Chapter, Topic_No, Ques_Num, Per_topic, Question, Answer) VALUES ( $Chapter, $Topic_No, $Ques_Num, $Per_topic, '$Question', '$Answer' )";
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a type="button" class="btn btn-primary nav-link active" href="create_cqc.php">Add New</a>
            </li>
          </ul>
        </div>
      </div>
