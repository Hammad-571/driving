<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=='GET'){
    ...
    $sql = "select * from C where Ques_Num=$Ques_Num";
    ...
    $Topic_Nr=$_POST["Topic_Nr"];
    $Per_topic=$_POST["Per_topic"];
    $Question = str_ireplace("'","''",$Question);
    

    $sql = "update C set Question='$Question',Topic_No='$Topic_No',Topic_Nr='$Topic_Nr',Per_topic='$Per_topic', Answer='$Answer', Chapter='$Chapter' where Ques_Num='$Ques_Num'";
    $result = $conn->query($sql);
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" class="fw-bold">
      <div class="container-fluid">
        <a class="navbar-brand" href="c.php">PHP CRUD OPERATION</a>
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="c.php">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="create_c.php">Add New</a>
            </li>
          </ul>
        </div>
      </div>
 ...
 <label>Topic: </label>
 <input type="text" name="Topic_Nr" value="<?php echo $Topic_Nr; ?>" class="form-control"> <br>
 ...
 <a class="btn btn-info" type="submit" name="cancel" href="c.php"> Cancel </a><br>
