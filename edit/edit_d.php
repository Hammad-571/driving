<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=='GET'){
    ...
    $sql = "select * from D where Ques_Num=$Ques_Num";
    ...
    $sql = "update D set Question='$Question',Topic_No='$Topic_No',Topic_Nr='$Topic_Nr',Per_topic='$Per_topic', Answer='$Answer', Chapter='$Chapter' where Ques_Num='$Ques_Num'";
    $result = $conn->query($sql);
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" class="fw-bold">
      <div class="container-fluid">
        <a class="navbar-brand" href="d.php">PHP CRUD OPERATION</a>
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="d.php">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="create_d.php">Add New</a>
            </li>
          </ul>
        </div>
      </div>
 ...
 <a class="btn btn-info" type="submit" name="cancel" href="d.php"> Cancel </a><br>
