...
<?php 
  ...
  $arg_num = $_SESSION['counter'];
  $x= 1;
  $i = -1;
  $query = mysqli_query($conn, "SELECT * FROM B WHERE Topic_No=$arg_num;");
  $ques = ["","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""];
  $ans = ["","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""];
  ...
  $ans = ["","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""];
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
      ...
      {
        $_SESSION['counter']= $_POST['input'];
      }
      if($_SESSION['counter']< 1)
      {
        $_SESSION['counter'] = 1;
      }
      else if($_SESSION['counter']> 866)
      {
        $_SESSION['counter'] = 1;
      }
      $arg_num = $_SESSION['counter'];
...
var arrayArg = <?php echo json_encode($arrayArg); ?>;
var argNum =<?php echo json_encode($arg_num); ?>;; 
var strQues = arrayQues[1];
var strAns = arrayAns[1];
var strArg = arrayArg[1];
var ansGiven = ["","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""];
var question = [];
var answer = [];
var voice = 1;
var clicks = new Array(40);
for(var f=0 ; f<40;f++)
{
    clicks[f]= 0;
}
...
function img(){
    if((argNum > 6 && argNum < 10 ) || (argNum > 55 && argNum < 402 ) || (argNum > 403 && argNum < 410 ) || (argNum > 410 && argNum < 433 ) ||  (argNum > 433 && argNum < 438 ) || argNum === 463 || argNum === 485 || (argNum > 488 && argNum < 492) || (argNum > 492 && argNum < 503) || (argNum > 505 && argNum < 511) || (argNum > 513 && argNum < 516) || argNum === 520 || (argNum > 523 && argNum < 529) || argNum === 530 || (argNum > 543 && argNum < 547) || (argNum > 556 && argNum < 600) || (argNum > 672 && argNum < 679) || (argNum > 679 && argNum < 684) || (argNum > 710 && argNum < 720) || argNum === 744  || argNum === 760 || argNum === 761 )
  {
    document.getElementById("logo").style.display = "block";
    document.getElementById("img_td").style.display = "block";
    document.getElementById('img').src="images/b/"+argNum+".png";
  }
  else
  {
    document.getElementById("img_td").style.display = "none";
...
}function ans29()
{
    ...
    {
        ansGiven[29] ="F";
        document.getElementById('ans29').src="images/falso.png";
    }
    else
    {
      ansGiven[29] ="V";
      document.getElementById('ans29').src="images/vero.png";
    }
}function ans30()
{
    clicks[30]++;
    ...
    {
        ansGiven[30] ="F";
        document.getElementById('ans30').src="images/falso.png";
    }
    else
    {
      ansGiven[30] ="V";
      document.getElementById('ans30').src="images/vero.png";
    }
}function ans31()
{
    clicks[31]++;
    ...
    {
        ansGiven[31] ="F";
        document.getElementById('ans31').src="images/falso.png";
    }
    else
    {
      ansGiven[31] ="V";
      document.getElementById('ans31').src="images/vero.png";
    }
}function ans32()
{
    clicks[32]++;
    ...
    {
        ansGiven[32] ="F";
        document.getElementById('ans32').src="images/falso.png";
    }
    else
    {
      ansGiven[32] ="V";
      document.getElementById('ans32').src="images/vero.png";
    }
}function ans33()
{
    clicks[33]++;
    ...
    {
        ansGiven[33] ="F";
        document.getElementById('ans33').src="images/falso.png";
    }
    else
    {
      ansGiven[33] ="V";
      document.getElementById('ans33').src="images/vero.png";
    }
}function ans34()
{
    clicks[34]++;
    ...
    {
        ansGiven[34] ="F";
        document.getElementById('ans34').src="images/falso.png";
    }
    else
    {
      ansGiven[34] ="V";
      document.getElementById('ans34').src="images/vero.png";
    }
}function ans35()
{
    clicks[35]++;
    ...
    {
        ansGiven[35] ="F";
        document.getElementById('ans35').src="images/falso.png";
    }
    else
    {
      ansGiven[35] ="V";
      document.getElementById('ans35').src="images/vero.png";
    }
}
function ans0()
{
    ...
    {
        ansGiven[0] ="F";
        document.getElementById('ans0').src="images/falso.png";
    }
    else
    {
      ansGiven[0] ="V";
      document.getElementById('ans0').src="images/vero.png";
    }
}
function ans1()
{
...
<body>
    ...
    <div style="padding-bottom: 40px; height:auto" id="flex2">
    <form id = "flex2" id="form" method="post" >
            <input type="submit" name="back" value="&laquo" class="intervalli_quiz1" style="width: 100px;" onclick="previous()">
            <input type = "button"class="intervalli_quiz2" onclick="correggi()" value="Correggi">
            <input type="submit" name="next" value="&raquo" class="intervalli_quiz1" style="width: 100px;" onclick="next()">
            <input class="intervalli_quiz" value="" name = "input" style="width: 150px; height:80px; font-size:40px;"type="text"  id="inputId">
            <input type="submit" name="search" value="Vai" class="intervalli_quiz1" type="button" onclick="getInputValue();">
      </form>
    </div>
</body>
