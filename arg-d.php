...
<?php 
  ...
  {
  $i = -1;
  $query = mysqli_query($conn, "SELECT * FROM D WHERE Topic_No=$x;");
  $ques = ["","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""];
  $ans = ["","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""];
...
function img(){
    if((argNum >4 && argNum <7) || (argNum > 18 && argNum < 30 ) || (argNum > 47 && argNum < 58 )  || (argNum > 58 && argNum < 68) || (argNum > 282 && argNum < 300) )
  {
    document.getElementById("logo").style.display = "block";
    document.getElementById("img_td").style.display = "block";
    document.getElementById('img').src="images/d/"+argNum+".png";
  }
  else
  {
