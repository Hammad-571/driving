...
<?php 
  ...
  {
  $i = -1;
  $query = mysqli_query($conn, "SELECT * FROM C WHERE Topic_No=$x;");
  $ques = ["","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""];
  $ans = ["","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""];
...
function img(){
  if((argNum >4 && argNum <7) || (argNum > 18 && argNum < 30 ) || (argNum > 47 && argNum < 86 ) || argNum === 106 || argNum === 107  || (argNum > 308 && argNum < 326 ) )
  {
    document.getElementById("logo").style.display = "block";
    document.getElementById("img_td").style.display = "block";
    document.getElementById('img').src="images/c/"+argNum+".png";
  }
  else
  {
  ...
  for(let i= 2; i<question.length+2; i++ )
    {
        ...
        myTable.innerHTML += "<div class = \"dot\" id=\"removeQues\"><hr style=\"height:8px;border-width:0;color:gray;background-color:gray\" ></div>"
    }   
}
